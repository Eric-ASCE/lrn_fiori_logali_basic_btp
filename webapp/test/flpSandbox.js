		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invListAsceLog",
									"targetURL": "#invascelogaliinvoiceascelogali-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invascelogaliinvoiceascelogali-display": {
								"semanticObject": "invascelogaliinvoiceascelogali",
								"action": "display",
								"description": "Lista de facturas prueba Fiori",
								"title": "invListAsceLog",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invascelogali.invoiceascelogali",
									"url": sap.ui.require.toUrl("invascelogali/invoiceascelogali")
								}
							}
						}
					}
